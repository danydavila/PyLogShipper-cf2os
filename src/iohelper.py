...
def parse_url(url):
	...
	if 'searchfor' in dict_result:
		url_dict['search_keyword'] = normalize_string(dict_result['searchfor'][0])
...
def get_search_keyword(query_string: str | None = None):
	...
	if 'searchfor' in dict_result:
		query_dict['search_keyword'] = normalize_string(dict_result['searchfor'][0])
	...
	if 'query' in dict_result:
		query_dict['search_keyword'] = normalize_string(dict_result['query'][0])
